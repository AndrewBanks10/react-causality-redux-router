...
var _PathUtils = __webpack_require__(0);
...
exports.internalHistory = exports.history = undefined;
exports.default = cBH;
...
var transitionFromCurrentState = function transitionFromCurrentState(pathname) {
    historyCache[activeURL] = _causalityRedux2.default.store.getState();
    activeURL = pathname;
};
...
var handleListen = function handleListen(location, action) {
    switch (action) {
        ...
        case 'POP':
            transitionFromCurrentState(location.pathname);
            if (historyCache[activeURL]) _causalityRedux2.default.copyState(historyCache[activeURL]);
            break;
        case 'REPLACE':
...
var internalHistory = exports.internalHistory = function internalHistory() {
    return {
        activeURL: activeURL,
